...
```bash
pip install collab_learning_extension
```
...
```bash
pip uninstall collab_learning_extension
```
...
# Change directory to the collab_learning_extension directory
...
folder is located. Then you can remove the symlink named `collab_learning_extension` within that folder.
