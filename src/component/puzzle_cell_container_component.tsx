...
export class PuzzleCellContainerComponent extends React.Component<PuzzleCellContainerComponentProps, PuzzleCellContainerComponentState>{
    componentDidMount() {
    ...
    render() {
        ...
        this.state?.cells.forEach(element => {
            ...
            cellComponents.push(<PuzzleCellComponent signal={signal} initCell={element} onCellChanged={this.props.onCellChanged} />)
        });
    ...
    private _cellSignals: Map<string, Signal<PuzzleCellContainerComponent,Cell>> = new Map<string,Signal<PuzzleCellContainerComponent,Cell>>();
}